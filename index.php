...
<html lang="en">
	...
	?>
				...
				<div class="container">
					...
					<div class="row 200%">
						<section class="4u 12u$(small)">
							...
							<p><b> Digital Market</b></p>
						</section>
						<section class="4u 12u$(small)">
							<i class="icon big rounded fa-comments"></i>
							<p><b>PLUCXEL-Blog</b> </p>
						</section>
						<section class="4u$ 12u$(small)">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">PLUCXEL &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px"> PLUCXEL Fam<span>GAREBHAVI HALLI</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">8050734314</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:PLUCXEL@gmail.com" style="color:white">shashuyan@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About PLUCXEL</b></span>
				PLUCXEL is e-commerce trading platform for healthy ingredients
			</p>
